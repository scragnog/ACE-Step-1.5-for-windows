...
- POST /cancel_task                Cancel a queued/running job
...
- GET  /v1/models/list             List models with active/preloaded status
- GET  /v1/models/status           Lightweight model status check
- POST /v1/models/switch           Hot-swap DiT model
- GET  /v1/stats                   Server queue/job statistics
- POST /v1/lora/*                  LoRA adapter lifecycle (load/unload/toggle/scale/status + advanced)
- GET  /v1/audio                   Download audio file
- POST /v1/audio/diff              A/B audio difference for ablation analysis
- GET  /v1/steering/*              TADA activation steering endpoints
- GET  /v1/system/metrics          GPU/CPU/RAM metrics
- GET  /v1/system/logs             Log streaming
- GET  /v1/stems/*                 Stem separation endpoints
- GET  /v1/audio/enhance/*         Audio enhancement endpoints
